...
From a different perspective, Batool (2013) mentioned that the rise of social media over the past few years has changed the overall perspective of the web, socialization, and personalization. The use of data from social networks for different purposes such as election prediction, sentiment analysis, marketing, communication, commerce, and education is increasing. The application of sentiment analysis in different fields in recent years, such as marketing, Mostafa (2013). As mentioned in the study, the analysis of Twitter tweets is used to track the community's views and confidence on different mobile communication company brands. Rambocas (2013) states that sentiment analysis can effectively evaluate consumer opinions in real time, and it allows data collection and analysis from very large samples without any obstacles and time delays. With sentiment analysis, marketers can collect rich data about attitudes and opinions in real time without affecting reliability, effectiveness, and generalizability. Marketers can also collect feedback when attitudes and opinions occur without having to perform lengthy and expensive market research activities; in the political field, Wang (2012) proposed a method for real-time analysis of the public against presidential candidates in the 2012 US election A system of emotions, the system is expressed on Twitter, a microblogging service. They pointed out that traditional political analysis has been difficult to handle the current situation of information explosion. The application of sentiment analysis allows people to grasp political public opinion more effectively and quickly; Balahadia (2016) This research uses opinion mining and sentiment analysis to develop teachers Performance evaluation tool. This study may help determine the strengths and weaknesses of faculty based on positive and negative feedback from students using English or Filipino.
